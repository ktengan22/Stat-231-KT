...
-->
```{r code for justices.R, eval = FALSE}
url <- "https://en.wikipedia.org/wiki/List_of_justices_of_the_Supreme_Court_of_the_United_States"
...
The histogram is right skewed, with about three peaks. The most sc justices served about 8 years, then the second most served about 18, and then 5-7 served between 25 and 30 years. 

```{r visualization, fig.width = 3.6, fig.height = 2.4, fig.align = "center"}
