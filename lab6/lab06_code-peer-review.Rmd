...
1. Line 147 and 148 - I really liked the way you made sure to start a new line after each argument as for the cleanliness of the code.
2. I like how the notes and comments are clearly outlined and detail exactly what is happening below.
3. Functionality 30 - outputs correctly producing all desired results. 
4. Readability 10 - It was really easy to follow the systematic approach to each question as each step was clearly outlined and described by comments. 
5. Documentation
