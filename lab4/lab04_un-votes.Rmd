...
> The shape of the points when adding shape = 2 changes from a circle in the original, to triangles. 
...
> I noticed that the shape of the points have now changed to asterics, and I believe, when compared against the former graphs, the size of the points are slightly smaller. 
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
  ...
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       ...
       y = "% Yes",
       x = "Year",
       color = "Country", shape = "Country") #capitalization of the name matters 
```
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) +
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
       color = "Country", lty = "Country", shape = "Country") #capitalization of the name matters - make sure all "Country" are spelled the same sand case sensitive
```
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) + scale_color_brewer() +
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
       color = "country", lty = "country") #capitalization of the name matters 
```
...
> no because color blindness; and you can't see India

```{r brewer-options, fig.width = 6.5, fig.height = 3}
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) + scale_color_brewer(type = "div", palette = 1) +
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) + scale_color_brewer() + scale_color_brewer(type = "qual", palette = 2)
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) + scale_color_brewer() + scale_color_manual(values = c("green", "purple", "blue"))
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
...
ggplot(data = unvotes_hr, mapping = aes(x = year, y = percent_yes, 
                                        color = country)) +
  geom_point(aes(shape = country, color = country)) +
  geom_smooth(aes(lty = country), method = "loess", se = FALSE) + scale_color_brewer() + scale_color_manual(values = c("#05a05a", "#844185", "#024a81"))
  labs(title = "Percentage of 'Yes' votes  on human rights issues",
       subtitle = "UN General Assembly, 1946 to 2019",
       y = "% Yes",
       x = "Year",
