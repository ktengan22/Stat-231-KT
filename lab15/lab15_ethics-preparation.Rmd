...
It is hard to know for sure. Perhaps it is a matter of diverse individuals studying
these fields of STEM or other things. There is data that shows people of color
tend to study more humanities fields. Perhaps its who is getting hired into these
companies. 
...
The fact that humans create the algorithms and code, all of those biases, 
lived experiences, and systemic issues will also fuel the AI's decision making. 
...
I see something very dangerous in sciencizing things to legitimize decisions. 
There are far too many instances of scientific racism amongst black and indigenous
communities that I fail to see something positive emerging from the statement that 
"data and algorithms are always going to be more effective and fair."
...
Recap:
- complex risk assessment and random people on twitter predicted at the same accuracy
- was basing these things off of age and prior incarceration
  - blacks much much more likely to be incarcerated than white counterparts
- humans have simple mind: young and doing crime -> likely to do it again
  - but if old and not much crime then probably not
  
It is dangerous the weight that we put into these systems. 
...
Algorithms remove the blame from the human. 
